...
public class NewsQuestionsPresenter {
    ...
    public void questionsGot(NewsArrays newsArrays) {
        ...
        if (newsQuestionsFragment == null || !newsQuestionsFragment.isOpen)
            return;
    ...
    public void errorOccured(int errorType) {
        if (!newsQuestionsFragment.isOpen) {
            return;
        }

        //System.out.println(newsQuestionsFragment.isVisible() + " " + newsQuestionsFragment.isDetached() + " " + newsQuestionsFragment.isHidden() + " " + newsQuestionsFragment.isRemoving());
